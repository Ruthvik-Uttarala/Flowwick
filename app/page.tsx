        ...
        {features.map((feature) => {
          ...
          return (
            <motion.div
              ...
              className="warm-card warm-card-hover group rounded-2xl p-6 cursor-default"
            >
              <div
        ...
        <div className="mt-5 grid gap-3 sm:grid-cols-5">
          {[
            ...
            >
              ...
              <p className="mt-1 text-sm font-semibold text-[#2B1B12]">{s.step}</p>
              <p className="mt-1 text-xs text-[#2B1B12]/35">{s.desc}</p>
            </motion.div>
          ))}
        </div>
      </motion.section>
